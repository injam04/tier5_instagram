    ...
    <div className='footer'>
      ...
      <div className='comment-lists'>
        <div className='single-c'>
          <div className='left'>
            <p className='name mb-0 fs-14 fw-600 pointer'>sknizamu</p>
            <p className='comm mb-0 fs-14 pointer'>eita kon jaiga?</p>
          </div>
          <div className='right'>
            <svg
              aria-label='Like'
        ...
        <div className='single-c'>
          <div className='left'>
            <p className='name mb-0 fs-14 fw-600 pointer'>md.nahid12</p>
            <p className='comm mb-0 fs-14 pointer'>
              That legendary tour moment?😮
            </p>
          </div>
          <div className='right'>
            <svg
      ...
      <div className='time'>
        <span className='text-gray fs-12 text-uppercase'>11 hours ago</span>
      </div>
    </div>
