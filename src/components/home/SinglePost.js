...
class SinglePost extends Component {
  ...
  postComment = (e) => {
    ...
    if (this.state.comment.trim() === '') {
      ...
      this.props.postComment(this.props.post, postData, callback);
    }
  };
        ...
        <div className='single'>
          ...
          <div className='footer'>
            <div className='actions'>
              <div className='left'>
                {this.props.post.user_has_liked ? (
                  <svg
                    onClick={() =>
                      this.props.actionLikeSave(this.props.post, 'like', false)
                    }
                    aria-label='Unlike'
                  ...
                  <svg
                    onClick={() =>
                      this.props.actionLikeSave(this.props.post, 'like', true)
                    }
                    aria-label='Like'
                    className=''
                    color=''
              ...
              <div className='right'>
                {this.props.post.user_has_saved ? (
                  <svg
                    onClick={() =>
                      this.props.actionLikeSave(this.props.post, 'save', false)
                    }
                    aria-label='Remove'
                    className='_ab6-'
                    color='#262626'
                  ...
                  <svg
                    onClick={() =>
                      this.props.actionLikeSave(this.props.post, 'save', true)
                    }
                    aria-label='Save'
                    className='_ab6-'
                    color=''
            ...
            <div className='liked fs-14'>
              ...
              <span className='fw-600 fs-14 pointer'>
                {this.props.post.likedByMain}
              </span>{' '}
              and <span className='fw-600 fs-14 pointer'>others</span>
            </div>
            <div className='caption fs-14'>
              <p className='name mb-0 fs-14 fw-600 pointer'>
                {this.props.post.user.username}
              </p>
              <p className='caption-txt mb-0 fs-14'>
              ...
              <div className='comment-lists'>
                {this.props.post.comments.length > 2 && (
                  <span className='text-gray fs-14 pointer'>
                    viwe all {this.props.post.comments.length} comments
                  </span>
                )}
                {this.props.post.comments.slice(-2).map((comment, i) => (
          ...
          <div className='input-comment'>
            ...
            <form className='main-inp' onSubmit={this.postComment}>
              <input
                type='text'
              ...
              <button
                type='submit'
                className={this.state.comment.trim() !== '' ? 'activee' : ''}
              >
                Post
              </button>
            </form>
